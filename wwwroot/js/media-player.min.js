...
mejs.version = "2.13.0", mejs.meIndex = 0, mejs.plugins = {
        ...
        getScriptPath: function (e) {
            for (var t, i, n, s, o, a, r = 0, l = "", d = "", u = document.getElementsByTagName("script"), c = u.length, m = e.length; c > r; r++) {
                for (s = u[r].src, i = s.lastIndexOf("/"), i > -1 ? (a = s.substring(i + 1), o = s.substring(0, i + 1)) : (a = s, o = ""), t = 0; m > t; t++)
        ...
        flashName: "media/flashmediaelement.swf",
        flashStreamer: "",
        enablePluginSmoothing: !1,
        enablePseudoStreaming: !1,
        pseudoStreamingStartQueryParam: "start",
        silverlightName: "media/silverlightmediaelement.xap",
        ...
        determinePlayback: function (e, t, i, n, s) {
            ...
            if ("undefined" != typeof t.type && "" !== t.type)
                ...
                for (o = 0; o < e.childNodes.length; o++) d = e.childNodes[o], 1 == d.nodeType && "source" == d.tagName.toLowerCase() && (s = d.getAttribute("src"), u = this.formatType(s, d.getAttribute("type")), f = d.getAttribute("media"), (!f || !window.matchMedia || window.matchMedia && window.matchMedia(f).matches) && v.push({
                    type: u,
                    url: s
                }));
            if (!n && v.length > 0 && null !== v[0].url && this.getTypeFromFile(v[0].url).indexOf("audio") > -1 && (g.isVideo = !1), mejs.MediaFeatures.isBustedAndroid && (e.canPlayType = function (e) {
                ...
                for (n || (h = document.createElement(g.isVideo ? "video" : "audio"), e.parentNode.insertBefore(h, e), e.style.display = "none", g.htmlMediaElement = e = h), o = 0; o < v.length; o++)
                    if ("" !== e.canPlayType(v[o].type).replace(/no/, "") || "" !== e.canPlayType(v[o].type.replace(/mp3/, "mpeg")).replace(/no/, "")) {
            ...
            if ("auto" === t.mode || "auto_plugin" === t.mode || "shim" === t.mode)
                for (o = 0; o < v.length; o++)
                    for (u = v[o].type, a = 0; a < t.plugins.length; a++)
                        for (c = t.plugins[a], m = mejs.plugins[c], r = 0; r < m.length; r++)
                            if (p = m[r], null == p.version || mejs.PluginDetector.hasPluginVersion(c, p.version))
                                for (l = 0; l < p.types.length; l++)
                                    if (u == p.types[l]) return g.method = c, g.url = v[o].url, g;
    ...
    function (e) {
        mejs.MepDefaults = {
                ...
                init: function () {
                    ...
                    if (t.isDynamic = "audio" !== s && "video" !== s, t.isVideo = t.isDynamic ? t.options.isVideo : "audio" !== s && t.options.isVideo, i.isiPad && t.options.iPadUseNativeControls || i.isiPhone && t.options.iPhoneUseNativeControls) t.$media.attr("controls", "controls"), i.isiPad && null !== t.media.getAttribute("autoplay") && (t.media.load(), t.media.play());
                    ...
                    if (!s.created) {
                        if (s.created = !0, s.media = e, s.domNode = t, !(o.isAndroid && s.options.AndroidUseNativeControls || o.isiPad && s.options.iPadUseNativeControls || o.isiPhone && s.options.iPhoneUseNativeControls)) {
                            ...
                            for (i in s.options.features)
                                if (n = s.options.features[i], s["build" + n]) try {
                            ...
                            s.container.trigger("controlsready"), s.setPlayerSize(s.width, s.height), s.setControlsSize(), s.isVideo && (mejs.MediaFeatures.hasTouch ? s.$media.bind("touchstart", function () {
                                ...
                                s.options.clickToPlayPause && (s.media.paused ? s.media.play() : s.media.pause())
                                ...
                                s.media.pause(), s.setProgressRail && s.setProgressRail(), s.setCurrentRail && s.setCurrentRail(), s.options.loop ? s.media.play() : !s.options.alwaysShowControls && s.controlsEnabled && s.showControls()
                        ...
                        r && "native" == e.pluginType && (e.load(), e.play()), s.options.success && ("string" == typeof s.options.success ? window[s.options.success](s.media, s.domNode, s) : s.options.success(s.media, s.domNode, s))
                    }
                },
                    ...
                    if (t.isVideo) {
                        var a = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(n),
                            ...
                            l = e('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(n).click(function () {
                                o.options.clickToPlayPause && (s.paused ? s.play() : s.pause())
                            });
                    ...
                    o.globalBind("keydown", function (e) {
                        if (t.hasFocus && t.options.enableKeyboard)
                            for (var i = 0, n = t.options.keyActions.length; n > i; i++)
                                for (var o = t.options.keyActions[i], a = 0, r = o.keys.length; r > a; a++)
                                    if (e.keyCode == o.keys[a]) return e.preventDefault(), o.action(t, s, e.keyCode), !1;
                        return !0
            ...
            buildtracks: function (t, i, n, s) {
                if (0 != t.tracks.length) {
                    ...
                    if (a.domNode.textTracks)
                        for (var o = a.domNode.textTracks.length - 1; o >= 0; o--) a.domNode.textTracks[o].mode = "hidden";
                ...
                if ("undefined" != typeof this.tracks) {
                    ...
                    if (null != i && i.isLoaded) {
                        for (e = 0; e < i.entries.times.length; e++)
                            if (t.media.currentTime >= i.entries.times[e].start && t.media.currentTime <= i.entries.times[e].stop) return t.captionsText.html(i.entries.text[e]), void t.captions.show().height(0);
                        t.captions.hide()
            ...
            webvvt: {
                ...
                parse: function (t) {
                    for (var i, n, s = 0, o = mejs.TrackFormatParser.split2(t, /\r?\n/), a = {
                        ...
                        if (this.pattern_identifier.exec(o[s]) && (s++, i = this.pattern_timecode.exec(o[s]), i && s < o.length)) {
                            for (s++, n = o[s], s++;
                                "" !== o[s] && s < o.length;) n = n + "\n" + o[s], s++;
            ...
            dfxp: {
                parse: function (t) {
                    ...
                    if (r.length) {
                        ...
                        if (d.length)
                            for (i = {}, s = 0; s < d.length; s++) i[d[s].name.split(":")[1]] = d[s].value
                    }
    ...
    function (e) {
        e.extend(mejs.MepDefaults, {
            ...
            renderContextMenu: function (t, i) {
                for (var n = this, s = "", o = n.options.contextMenuItems, a = 0, r = o.length; r > a; a++)
