...
$(document).ready(function () {
	...
	Template Settings
    -----------------------------------------------------------*/
    setTimeout(() => { document.getElementById("load").classList.add("display_none") }, 1000);
    ...
    //const url_replaces = ['/Home', '/Table', '/Engineerunit','/Dataview'];
    //var virtual = window.location.pathname;//.replace("/Table", "");
    //url_replaces.forEach(element => (virtual = virtual.replace(element, "")));
    //virtual = virtual.replace("/DataView", "").replace("/Engineerunit", "").replace("/Home","");
    var settings = '<a id="settings" href="#changeSkin" data-toggle="modal">' +
        '<i class="fa fa-gear"></i> 更換背景' +
        '</a>' +
        '<div class="modal fade" id="changeSkin" tabindex="-1" role="dialog" aria-hidden="true">' +
        '<div class="modal-dialog modal-lg">' +
        '<div class="modal-content">' +
        '<div class="modal-header">' +
        '<h4 class="modal-title" style="display:inline;">更換背景主題顏色</h4>' +
        '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' +
        '</div>' +
        '<div class="modal-body">' +
        '<div class="row template-skins">' +
        '<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-violate.jpg" alt="">` +
        '</a>' +
        `<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">` +
        `<img src="${geturl()}/img/skin-lights.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-city.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-greenish.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-night.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-blue.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-sunny.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-cloth.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-tectile.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-chrome.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-ocean.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-sunset.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-yellow.jpg" alt="">` +
        '</a>' +
        '<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" onclick="changebackgroundskin(this);" href="">' +
        `<img src="${geturl()}/img/skin-kiwi.jpg" alt="">` +
        '</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    (function () {
        /* Menu Toggle */
        $('body').on('click touchend', '#menu-toggle', function (e) {
            e.preventDefault();
            console.log("croll show hide");
