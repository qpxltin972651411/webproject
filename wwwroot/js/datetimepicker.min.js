    ...
    n.prototype = {
        ...
        fillDate: function () {
            var e = this.viewDate.getUTCFullYear(),
                ...
                s = a(this._date.getUTCFullYear(), this._date.getUTCMonth(), this._date.getUTCDate(), 0, 0, 0, 0),
                n = "object" == typeof this.startDate ? this.startDate.getUTCFullYear() : -1 / 0,
                o = "object" == typeof this.startDate ? this.startDate.getUTCMonth() : -1,
                d = "object" == typeof this.endDate ? this.endDate.getUTCFullYear() : 1 / 0,
            ...
            c.setUTCDate(l), c.setUTCDate(l - (c.getUTCDay() - this.weekStart + 7) % 7), (e == n && o >= i || n > e) && this.widget.find(".datepicker-days th:eq(0)").addClass("disabled"), (e == d && i >= h || e > d) && this.widget.find(".datepicker-days th:eq(2)").addClass("disabled");
            ...
            var w = this._date.getUTCFullYear(),
                v = this.widget.find(".datepicker-months").find("th:eq(1)").text(e).end().find("span").removeClass("active");
            w === e && v.eq(this._date.getUTCMonth()).addClass("active"), n > w - 1 && this.widget.find(".datepicker-months th:eq(0)").addClass("disabled"), w + 1 > d && this.widget.find(".datepicker-months th:eq(2)").addClass("disabled");
            for (var k = 0; 12 > k; k++) e == n && o > k || n > e ? t(v[k]).addClass("disabled") : (e == d && k > h || e > d) && t(v[k]).addClass("disabled");
            g = "", e = 10 * parseInt(e / 10, 10);
            var T = this.widget.find(".datepicker-years").find("th:eq(1)").text(e + "-" + (e + 9)).end().find("td");
            this.widget.find(".datepicker-years").find("th").removeClass("disabled"), n > e && this.widget.find(".datepicker-years").find("th:eq(0)").addClass("disabled"), e + 9 > d && this.widget.find(".datepicker-years").find("th:eq(2)").addClass("disabled"), e -= 1;
            for (var k = -1; 11 > k; k++) g += '<span class="year' + (-1 === k || 10 === k ? " old" : "") + (w === e ? " active" : "") + (n > e || e > d ? " disabled" : "") + '">' + e + "</span>", e += 1;
            T.html(g)
        },
        fillHours: function () {
        ...
        fillTime: function () {
            if (this._date) {
                var t = this.widget.find(".timepicker span[data-time-component]"),
                    ...
                    a = "AM";
                e && (s >= 12 && (a = "PM"), 0 === s ? s = 12 : 12 != s && (s %= 12), this.widget.find(".timepicker [data-action=togglePeriod]").text(a)), s = i(s.toString(), 2, "0");
                var n = i(this._date.getUTCMinutes().toString(), 2, "0"),
                    o = i(this._date.getUTCSeconds().toString(), 2, "0");
                t.filter("[data-time-component=hours]").text(s), t.filter("[data-time-component=minutes]").text(n), t.filter("[data-time-component=seconds]").text(o)
            }
        },
        click: function (e) {
            ...
            if (1 === i.length && !i.is(".disabled")) switch (i[0].nodeName.toLowerCase()) {
                case "th":
                    switch (i[0].className) {
                        ...
                        case "next":
                            ...
                            "prev" === i[0].className && (o = -1 * o), s["set" + n](s["get" + n]() + o), this.fillDate(), this.set()
                    }
                    break;
                case "span":
                    if (i.is(".month")) {
                ...
                case "td":
                    if (i.is(".day")) {
                        ...
                        i.is(".old") ? 0 === r ? (r = 11, d -= 1) : r -= 1 : i.is(".new") && (11 == r ? (r = 0, d += 1) : r += 1), this._date = a(d, r, h, this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds()), this.viewDate = a(d, r, Math.min(28, h), 0, 0, 0, 0), this.fillDate(), this.set(), this.notifyChange()
                    }
            }
        },
        actions: {
            ...
            selectHour: function (e) {
                ...
                if (this.options.pick12HourFormat) {
                    ...
                    a >= 12 ? 12 != s && (s = (s + 12) % 24) : 12 === s ? s = 0 : s %= 12
                }
                ...
                if (o.end == n.length) {
                    if (!o.pattern.test(n.slice(o.start))) {
                        for (n = n.slice(0, n.length - 1);
                            (o = this._mask[this._maskPos]) && o.character;) n += o.character, this._maskPos++;
                        return n += a, o.end != n.length ? (s.val(n), !1) : o.pattern.test(n.slice(o.start)) ? (s.val(n), this._maskPos++, !1) : (s.val(n.slice(0, o.start)), !1)
                    }
                    this._maskPos++
                }
            }
        ...
        formatDate: function (t) {
            return this.format.replace(p, function (e) {
                var s, a, n, o = e.length;
                if ("ms" === e && (o = 1), a = d[e].property, "Hours12" === a) n = t.getUTCHours(), 0 === n ? n = 12 : 12 !== n && (n %= 12);
                else {
                    if ("Period12" === a) return t.getUTCHours() >= 12 ? "PM" : "AM";
                    s = "get" + a, n = t[s]()
                }
                return "getUTCMonth" === s && (n += 1), "getUTCYear" === s && (n = n + 1900 - 2e3), i(n.toString(), o, "0")
            })
        },
        parseDate: function (t) {
            var e, i, s, a, n = {};
            if (!(e = this._formatPattern.exec(t))) return null;
            for (i = 1; i < e.length; i++) s = this._propertiesByIndex[i], s && (a = e[i], /^\d+$/.test(a) && (a = parseInt(a, 10)), n[s] = a);
        ...
        _finishParsingDate: function (t) {
            var e, i, s, n, o, r, d;
            return e = t.UTCFullYear, t.UTCYear && (e = 2e3 + t.UTCYear), e || (e = 1970), i = t.UTCMonth ? t.UTCMonth - 1 : 0, s = t.UTCDate || 1, n = t.UTCHours || 0, o = t.UTCMinutes || 0, r = t.UTCSeconds || 0, d = t.UTCMilliseconds || 0, t.Hours12 && (n = t.Hours12), t.Period12 && (/pm/i.test(t.Period12) ? 12 != n && (n = (n + 12) % 24) : n %= 12), a(e, i, s, n, o, r, d)
        },
        _compileFormat: function () {
            for (var t, i, s = [], a = [], n = this.format, o = {}, r = 0, h = 0; t = l.exec(n);) i = t[0], i in d ? (r++, o[r] = d[i].property, s.push("\\s*" + d[i].getPattern(this) + "\\s*"), a.push({
            ...
            this._mask = a, this._maskPos = 0, this._formatPattern = new RegExp("^\\s*" + s.join("") + "\\s*$"), this._propertiesByIndex = o
        },
        _attachDatePickerEvents: function () {
            ...
            this.widget.on("click", ".datepicker *", t.proxy(this.click, this)), this.widget.on("click", "[data-action]", t.proxy(this.doAction, this)), this.widget.on("mousedown", t.proxy(this.stopEvent, this)), this.pickDate && this.pickTime && this.widget.on("click.togglePicker", ".accordion-toggle", function (i) {
                ...
                if (n && n.length) {
                    ...
                    n.collapse("hide"), o.collapse("show"), s.find("i").toggleClass(e.timeIcon + " " + e.dateIcon), e.$element.find(".add-on i").toggleClass(e.timeIcon + " " + e.dateIcon)
                }
        ...
        return this.each(function () {
            var s = t(this),
                ...
                o = "object" == typeof e && e;
            a || s.data("datetimepicker", a = new n(this, t.extend({}, t.fn.datetimepicker.defaults, o))), "string" == typeof e && a[e](i)
        })
