! function (t) {
    ...
    var e = function (e, n) {
        this.$ns = "bootstrap-markdown", this.$element = t(e), this.$editable = {
            ...
            attrValues: [],
            content: null
        }, this.$options = t.extend(!0, {}, t.fn.markdown.defaults, n), this.$oldContent = null, this.$isPreview = !1, this.$editor = null, this.$textarea = null, this.$handler = [], this.$callback = [], this.$nextTab = [], this.showEditor()
    };
    e.prototype = {
        constructor: e,
        __alterButtons: function (e, n) {
            ...
            t.each(r, function (t, r) {
                var s = !0;
                s = i ? !1 : r.indexOf(e) < 0, 0 == s && n(a.$editor.find('button[data-handler="' + r + '"]'))
            })
        },
                ...
                for (l = 0; l < o.length; l++) {
                    ...
                    for (c = 0; c < h.length; c++) {
                        var f = h[c],
                            d = "",
                            p = i + "-" + f.name,
                            g = f.btnText ? f.btnText : "",
                            v = f.btnClass ? f.btnClass : "btn",
                            b = f.tabIndex ? f.tabIndex : "-1";
                        1 == f.toggle && (d = ' data-toggle="button"'), u.append('<button class="' + v + ' btn-default btn-sm tooltips" title="' + f.title + '" tabindex="' + b + '" data-provider="' + i + '" data-handler="' + p + '"' + d + '><span class="' + f.icon + '"></span> ' + g + "</button>"), a.push(p), s.push(f.callback)
                    }
                    n.append(u)
                }
            }
        ...
        __setListener: function () {
            ...
            this.$textarea.attr("rows", r), this.$textarea.css("resize", "none"), this.$textarea.on("focus", t.proxy(this.focus, this)).on("keypress", t.proxy(this.keypress, this)).on("keyup", t.proxy(this.keyup, this)), this.eventSupported("keydown") && this.$textarea.on("keydown", t.proxy(this.keydown, this)), this.$textarea.data("markdown", this)
        },
        __handle: function (e) {
            var n = t(e.currentTarget),
                ...
                s = r.indexOf(a),
                l = i[s];
            t(e.currentTarget).focus(), l(this), a.indexOf("cmdSave") < 0 && this.$textarea.focus(), e.preventDefault()
        },
        showEditor: function () {
            var e, n = this,
                r = this.$ns,
                i = this.$element,
                a = (i.css("height"), i.css("width"), this.$editable),
                s = this.$handler,
                l = this.$callback,
                o = this.$options,
                c = t("<div/>", {
                    "class": "md-editor tile",
                    click: function () {
                        n.focus()
                    }
                });
            if (null == this.$editor) {
                var h = t("<div/>", {
                    "class": "md-header tile-title"
                });
                if (o.buttons.length > 0 && (h = this.__buildButtons(o.buttons, h)), o.additionalButtons.length > 0 && (h = this.__buildButtons(o.additionalButtons, h)), c.append(h), i.is("textarea")) i.before(c), e = i, e.addClass("md-input"), c.append(e);
                else {
                    ...
                    e = t("<textarea/>", {
                        "class": "md-input",
                        val: f
                    }), c.append(e), a.el = i, a.type = i.prop("tagName").toLowerCase(), a.content = i.html(), t(i[0].attributes).each(function () {
                ...
                if (o.savable) {
                    var d = t("<div/>", {
                        ...
                        p = "cmdSave";
                    s.push(p), l.push(o.onSave), d.append('<button class="btn btn-success" data-provider="' + r + '" data-handler="' + p + '"><i class="icon icon-white icon-ok"></i> Save</button>'), c.append(d)
                }
                t.each(["height", "width"], function (t, e) {
                    "inherit" != o[e] && (jQuery.isNumeric(o[e]) ? c.css(e, o[e] + "px") : c.addClass(o[e]))
                }), this.$editor = c, this.$textarea = e, this.$editable = a, this.$oldContent = this.getContent(), this.__setListener(), this.$editor.attr("id", (new Date).getTime()), this.$editor.on("click", '[data-provider="bootstrap-markdown"]', t.proxy(this.__handle, this))
            } else this.$editor.show();
            return o.autofocus && (this.$textarea.focus(), this.$editor.addClass("active")), o.onShow(this), this
        },
        showPreview: function () {
            ...
            return this.$isPreview = !0, this.disableButtons("all").enableButtons("cmdPreview"), e = "string" == typeof r ? r : "object" == typeof markdown ? markdown.toHTML(i.val()) : i.val(), s.html(e), a && "md-footer" == a.attr("class") ? s.insertBefore(a) : i.parent().append(s), i.hide(), s.data("markdown", this), this
        },
        ...
        blur: function () {
            ...
            if (r.hasClass("active") || 0 == this.$element.parent().length) {
                if (r.removeClass("active"), n)
                    if (null != i.el) {
                        var a = t("<" + i.type + "/>"),
                            s = this.getContent(),
                            l = "object" == typeof markdown ? markdown.toHTML(s) : s;
                        t(i.attrKeys).each(function (t) {
                            a.attr(i.attrKeys[t], i.attrValues[t])
    ...
    t.fn.markdown = function (n) {
        return this.each(function () {
            var r = t(this),
                i = r.data("markdown"),
                a = "object" == typeof n && n;
            i || r.data("markdown", i = new e(this, a))
        })
            ...
            [{
                ...
                data: [{
                    ...
                    callback: function (t) {
                        var e, n, r = t.getSelection(),
                            i = t.getContent();
                        e = 0 == r.length ? "strong text" : r.text, "**" == i.substr(r.start - 2, 2) && "**" == i.substr(r.end, 2) ? (t.setSelection(r.start - 2, r.end + 2), t.replaceSelection(e), n = r.start - 2) : (t.replaceSelection("**" + e + "**"), n = r.start + 2), t.setSelection(n, n + e.length)
                    }
                }, {
                    name: "cmdItalic",
                    title: "Italic",
                    ...
                    callback: function (t) {
                        var e, n, r = t.getSelection(),
                            i = t.getContent();
                        e = 0 == r.length ? "emphasized text" : r.text, "*" == i.substr(r.start - 1, 1) && "*" == i.substr(r.end, 1) ? (t.setSelection(r.start - 1, r.end + 1), t.replaceSelection(e), n = r.start - 1) : (t.replaceSelection("*" + e + "*"), n = r.start + 1), t.setSelection(n, n + e.length)
                    }
                }, {
                    name: "cmdHeading",
                    title: "Heading",
                ...
                data: [{
                    ...
                    callback: function (t) {
                        ...
                        e = 0 == i.length ? "enter link description here" : i.text, r = prompt("Insert Hyperlink", "http://"), null != r && "" != r && "http://" != r && (t.replaceSelection("[" + e + "](" + r + ")"), n = i.start + 1, t.setSelection(n, n + e.length))
                    }
                }, {
                    name: "cmdImage",
                    title: "Image",
                    ...
                    callback: function (t) {
                        ...
                        e = 0 == i.length ? "enter image description here" : i.text, r = prompt("Insert Image Hyperlink", "http://"), null != r && (t.replaceSelection("![" + e + "](" + r + ' "enter image title here")'), n = i.start + 2, t.setNextTab("enter image title here"), t.setSelection(n, n + e.length))
                    }
                }]
            }, {
                name: "groupMisc",
                data: [{
                    ...
                    callback: function (e) {
                        ...
                        if (0 == i.length) n = "list text here", e.replaceSelection("- " + n), r = i.start + 2;
    ...
    var r = function (t) {
            var e = t;
            return e.data("markdown") ? void e.data("markdown").showEditor() : void e.markdown(e.data())
        },
        i = function (e) {
            var n, r = !1,
                i = t(e.currentTarget);
            "focusin" != e.type && "click" != e.type || 1 != i.length || "object" != typeof i[0] || (n = i[0].activeElement, t(n).data("markdown") || ("undefined" == typeof t(n).parent().parent().parent().attr("class") || t(n).parent().parent().parent().attr("class").indexOf("md-editor") < 0 ? ("undefined" == typeof t(n).parent().parent().attr("class") || t(n).parent().parent().attr("class").indexOf("md-editor") < 0) && (r = !0) : r = !1), r && t(document).find(".md-editor").each(function () {
                var e = t(n).parent();
                if (t(this).attr("id") != e.attr("id")) {
                    var r;
                    r = t(this).find("textarea").data("markdown"), null == r && (r = t(this).find('div[data-provider="markdown-preview"]').data("markdown")), r && r.blur()
                }
            }), e.stopPropagation())
        };
...
function (t) {
    ...
    function i(t, e) {
        ...
        return function (a) {
            ...
            var s = this[i].slice(),
                l = this[r].slice();
            this[r].unshift(e); {
                var o = this.processInline(a.substr(e.length)),
                    c = o[o.length - 1];
                this[r].shift()
            }
            if (c instanceof n) {
                o.pop();
                var h = a.length - c.len_after;
                return [h, [t].concat(o)]
            }
            return this[i] = s, this[r] = l, [e.length, e]
        }
    }
    ...
    function l(t) {
        return v(t) && t.length > 1 && "object" == typeof t[1] && !v(t[1]) ? t[1] : void 0
    }
    ...
    function c(t) {
        ...
        var e = t.shift(),
            n = {},
            r = [];
        for (!t.length || "object" != typeof t[0] || t[0] instanceof Array || (n = t.shift()); t.length;) r.push(arguments.callee(t.shift()));
        var i = "";
        for (var a in n) i += " " + a + '="' + o(n[a]) + '"';
    ...
    function h(t, e, n) {
        ...
        switch (i[0]) {
            ...
            case "code_block":
                i[0] = "pre", r = a ? 2 : 1;
                var s = ["code"];
                s.push.apply(s, i.splice(r)), i[r] = s;
                break;
            case "inlinecode":
                i[0] = "code";
                break;
            ...
            case "link_ref":
                i[0] = "a";
                var o = e[a.ref];
                if (!o) return a.original;
                delete a.ref, a.href = o.href, o.title && (a.title = o.title), delete a.original;
                break;
            case "img_ref":
                i[0] = "img";
                var o = e[a.ref];
                if (!o) return a.original;
                delete a.ref, a.src = o.href, o.title && (a.title = o.title), delete a.original
        }
        if (r = 1, a) {
            for (var c in i[1]) r = 2;
            1 === r && i.splice(r, 1)
        }
        for (; r < i.length; ++r) i[r] = arguments.callee(i[r], e, n);
        return i
    }

    function u(t) {
        for (var e = l(t) ? 2 : 1; e < t.length;) "string" == typeof t[e] ? e + 1 < t.length && "string" == typeof t[e + 1] ? t[e] += t.splice(e + 1, 1)[0] : ++e : (arguments.callee(t[e]), ++e)
    }
    var f = t.Markdown = function b(t) {
        switch (typeof t) {
            case "undefined":
                this.dialect = b.dialects.Gruber;
                break;
            case "object":
                this.dialect = t;
                break;
            default:
                if (!(t in b.dialects)) throw new Error("Unknown Markdown dialect '" + String(t) + "'");
                this.dialect = b.dialects[t]
        }
    ...
    var d = f.mk_block = function (t, r, i) {
        1 == arguments.length && (r = "\n\n");
        var a = new String(t);
        return a.trailing = r, a.inspect = n, a.toSource = e, void 0 != i && (a.lineNumber = i), a
    };
    f.prototype.split_blocks = function (t) {
        var e, n = /([\s\S]+?)($|\n(?:\s*\n|$)+)/g,
            i = [],
            a = 1;
        for (null != (e = /^(\s*\n)/.exec(t)) && (a += r(e[0]), n.lastIndex = e[0].length); null !== (e = n.exec(t));) i.push(d(e[1], e[2], a)), a += r(e[0]);
        return i
    }, f.prototype.processBlock = function (t, e) {
        var n = this.dialect.block,
            r = n.__order__;
        if ("__call__" in n) return n.__call__.call(this, t, e);
        for (var i = 0; i < r.length; i++) {
            var a = n[r[i]].call(this, t, e);
            if (a) return (!v(a) || a.length > 0 && !v(a[0])) && this.debug(r[i], "didn't return a proper array"), a
        }
        return []
    }, f.prototype.processInline = function (t) {
        return this.dialect.inline.__call__.call(this, String(t))
    }, f.prototype.toTree = function (t, e) {
    ...
    }, f.prototype.loop_re_over_block = function (t, e, n) {
        ...
        block: {
            ...
            lists: function () {
                function t(t) {
                    return new RegExp("(?:^(" + o + "{0," + t + "} {0,3})(" + a + ")\\s+)|(^" + o + "{0," + (t - 1) + "}[ ]{0,4})")
                }
                ...
                function n(t, e, n, r) {
                    ...
                    for (var a = 0; a < n.length; a++) {
                        var s = n[a],
                            l = "string" == typeof s;
                        l && i.length > 1 && "string" == typeof i[i.length - 1] ? i[i.length - 1] += s : i.push(s)
                    }
                }

                function r(t, e) {
                    for (var n = new RegExp("^(" + o + "{" + t + "}.*?\\n?)*$"), r = new RegExp("^" + o + "{" + t + "}", "gm"), i = []; e.length > 0;) {
                        if (n.exec(e[0])) {
                            var a = e.shift(),
                                s = a.replace(r, "");
                            i.push(d(s, a.trailing, a.lineNumber))
                        }
                        break
                    }
                    return i
                ...
                function i(t, e, n) {
                    ...
                    if (!(i[1] instanceof Array && "para" == i[1][0]))
                        if (e + 1 == n.length) i.push(["para"].concat(i.splice(1)));
                        else {
                            var a = i.pop();
                            i.push(["para"].concat(i.splice(1)), a)
                        }
                }
                var a = "[*+-]|\\d+\\.",
                    s = /[*+-]/,
                ...
                return function (a, o) {
                    ...
                    var h = a.match(l);
                    if (!h) return void 0;
                    for (var u, f, d = [], p = c(h), v = !1, b = [d[0].list];;) {
                        for (var m = a.split(/(?=\n)/), k = "", _ = 0; _ < m.length; _++) {
                            var w = "",
                                y = m[_].replace(/^\n/, function (t) {
                                    return w = t, ""
                                ...
                                x = t(d.length);
                            if (h = y.match(x), void 0 !== h[1]) {
                                k.length && (n(u, v, this.processInline(k), w), v = !1, k = ""), h[1] = e(h[1]);
                                var $ = Math.floor(h[1].length / 4) + 1;
                                if ($ > d.length) p = c(h), u.push(p), u = p[1] = ["listitem"];
                                else {
                                    var S = !1;
                                    for (f = 0; f < d.length; f++)
                                        if (d[f].indent == h[1]) {
                                            p = d[f].list, d.splice(f + 1), S = !0;
                                            break
                                        } S || ($++, $ <= d.length ? (d.splice($), p = d[$ - 1].list) : (p = c(h), u.push(p))), u = ["listitem"], p.push(u)
                                }
                                w = ""
                            }
                            y.length > h[0].length && (k += w + y.substr(h[0].length))
                        }
                        k.length && (n(u, v, this.processInline(k), w), v = !1, k = "");
                        var C = r(d.length, o);
                        C.length > 0 && (g(d, i, this), u.push.apply(u, this.toTree(C, [])));
                        var T = o[0] && o[0].valueOf() || "";
                        if (!T.match(l) && !T.match(/^ /)) break;
                        a = o.shift();
                        var B = this.dialect.block.horizRule(a, o);
                        if (B) {
                            b.push.apply(b, B);
                            break
                        }
            ...
            blockquote: function (t, e) {
                ...
                var n = [];
                if (">" != t[0]) {
                    for (var r = t.split(/\n/), i = []; r.length && ">" != r[0][0];) i.push(r.shift());
                    t = r.join("\n"), n.push.apply(n, this.processBlock(i.join("\n"), []))
                }
                for (; e.length && ">" == e[0][0];) {
                    var a = e.shift();
                    t = new String(t + t.trailing + a), t.trailing = a.trailing
                } {
                    var s = t.replace(/^> ?/gm, "");
                    this.tree
                }
                return n.push(this.toTree(s, ["blockquote"])), n
            },
        ...
        __oneElement__: function (t, e, n) {
            ...
            var a = new RegExp("([\\s\\S]*?)(" + (e.source || e) + ")");
            if (r = a.exec(t), !r) return [t.length, t];
        ...
        "[": function m(t) {
            var e = String(t),
                n = f.DialectHelpers.inline_until_char.call(this, t.substr(1), "]");
            if (!n) return [1, "["];
            var m, r, i = 1 + n[0],
                a = n[1];
            t = t.substr(i);
            ...
            if (s) {
                var l = s[1];
                if (i += s[0].length, l && "<" == l[0] && ">" == l[l.length - 1] && (l = l.substring(1, l.length - 1)), !s[3])
                    for (var o = 1, c = 0; c < l.length; c++) switch (l[c]) {
                        case "(":
                            o++;
                            break;
                        case ")":
                            0 == --o && (i -= l.length - c, l = l.substring(0, c))
                    }
                return l = this.dialect.inline.__call__.call(this, l, /\\/)[0], r = {
                    href: l || ""
                }, void 0 !== s[3] && (r.title = s[3]), m = ["link", r].concat(a), [i, m]
            }
            return s = t.match(/^\s*\[(.*?)\]/), s ? (i += s[0].length, r = {
                ref: (s[1] || String(a)).toLowerCase(),
                original: e.substr(0, i)
            }, m = ["link_ref", r].concat(a), [i, m]) : 1 == a.length && "string" == typeof a[0] ? (r = {
                ref: a[0].toLowerCase(),
                original: e.substr(0, i)
            }, m = ["link_ref", r, a[0]], [i, m]) : [1, "["]
        },
        "<": function (t) {
            var e;
    ...
    }, f.dialects.Gruber.inline["**"] = i("strong", "**"), f.dialects.Gruber.inline.__ = i("strong", "__"), f.dialects.Gruber.inline["*"] = i("em", "*"), f.dialects.Gruber.inline._ = i("em", "_"), f.buildBlockOrder = function (t) {
        var e = [];
        for (var n in t) "__order__" != n && "__call__" != n && e.push(n);
        t.__order__ = e
    }, f.buildInlinePatterns = function (t) {
        var e = [];
        for (var n in t)
            if (!n.match(/^__.*__$/)) {
    ...
    }, f.buildBlockOrder(f.dialects.Gruber.block), f.buildInlinePatterns(f.dialects.Gruber.inline), f.dialects.Maruku = f.subclassDialect(f.dialects.Gruber), f.dialects.Maruku.processMetaHash = function (t) {
        for (var e = s(t), n = {}, r = 0; r < e.length; ++r)
            if (/^#/.test(e[r])) n.id = e[r].substring(1);
            else if (/^\./.test(e[r])) n["class"] = n["class"] ? n["class"] + e[r].replace(/./, " ") : e[r].substring(1);
        else if (/\=/.test(e[r])) {
            var i = e[r].split(/\=/);
            n[i[0]] = i[1]
        }
        return n
    }, f.dialects.Maruku.block.document_meta = function (t) {
        ...
        return []
    }, f.dialects.Maruku.block.block_meta = function (t) {
        var e = t.match(/(^|\n) {0,3}\{:\s*((?:\\\}|[^\}])*)\s*\}$/);
        if (!e) return void 0;
        var n, r = this.dialect.processMetaHash(e[2]);
        if ("" === e[1]) {
            var i = this.tree[this.tree.length - 1];
            if (n = l(i), "string" == typeof i) return void 0;
            n || (n = {}, i.splice(1, 0, n));
            for (a in r) n[a] = r[a];
            return []
        }
        ...
        n = l(o[0]), n || (n = {}, o[0].splice(1, 0, n));
        for (a in r) n[a] = r[a];
        return o
    }, f.dialects.Maruku.block.definition_list = function (t, e) {
        var n, r = /^((?:[^\s:].*\n)+):\s+([\s\S]+)$/,
            i = ["dl"];
        if (!(l = t.match(r))) return void 0;
        for (var a = [t]; e.length && r.exec(e[0]);) a.push(e.shift());
        for (var s = 0; s < a.length; ++s) {
            var l = a[s].match(r),
                o = l[1].replace(/\n$/, "").split(/\n/),
                c = l[2].split(/\n:\s+/);
            for (n = 0; n < o.length; ++n) i.push(["dt", o[n]]);
            for (n = 0; n < c.length; ++n) i.push(["dd"].concat(this.processInline(c[n].replace(/(\n)\s+/, "$1"))))
        }
        return [i]
    }, f.dialects.Maruku.inline["{:"] = function (t, e, n) {
    ...
    var g, v = Array.isArray || function (t) {
