$(document).ready(function () {
    ...
    if (fullpath.includes("Table")) {
        document.getElementById("create").classList.add("active");
    } else if (fullpath.includes("DataView")) {
    ...
    virutal = virutal.replace("/DataView","");
    var settings = '<a id="settings" href="#changeSkin" data-toggle="modal">' +
        ...
        '<h4 class="modal-title">更換背景主題顏色</h4>' +
        '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' +
        '</div>' +
        '<div class="modal-body">' +
        '<div class="row template-skins">' +
        '<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-violate.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-lights.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-city.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-greenish.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-night.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-blue.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-sunny.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-cloth.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-tectile.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-chrome.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-ocean.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-sunset.jpg" alt="">` +
        '</a>' +
        '<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-yellow.jpg" alt="">` +
        '</a>' +
        '<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
        `<img src="${window.location.origin}${virutal}/img/skin-kiwi.jpg" alt="">` +
        '</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
