...
(function ($) {
    $.fn.piroBox_ext = function (opt) {
        ...
        var struct =
            ...
            '<a href="#prev" class="piro_prev" title="previous"><i class="fa fa-angle-left"></i></a>' +
            '<a href="#next" class="piro_next" title="next"><i class="fa fa-angle-right"></i></a>' +
            '<div class="piro_prev_fake"><i class="fa fa-angle-left"></i></div>' +
            '<div class="piro_next_fake"><i class="fa fa-angle-right"></i></div>' +
        ...
        $(piro_prev)
            ...
            .bind("click", function (c) {
                ...
                var obj_count = parseInt(
                    $('a[class*="pirobox_gall"]').filter(".item").attr("rev")
                );
                var start = $(this).is(".piro_prev") ?
                    $('a[class*="pirobox_gall"]').eq(obj_count - 1) :
                    $('a[class*="pirobox_gall"]').eq(obj_count + 1);
                start.click();
            });
                ...
                switch (params[0]) {
                    case "iframe":
                        ...
                        div_reg.piroFadeIn(300, function () {
                            div_reg.append(
                                '<iframe id="my_frame" class="my_frame" src="' +
                                p_link +
                                '" frameborder="0" allowtransparency="true" scrolling="auto" align="top"></iframe>'
                            );
                            $(".my_frame").css({
                                height: +params[2] + "px",
                                width: +params[1] + "px",
